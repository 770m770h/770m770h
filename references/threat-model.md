...
> The security brain of skill-scout. The scanner (`scripts/skillscout/patterns.py`) mirrors
...
[zero-width/bidi chars]               # zero-width / bidi smuggling
```
...
- This is **static analysis + reputation**. It cannot catch all **dynamic** behavior, and it
  cannot predict a **rug-pull** (clean now, malicious after a future update).
